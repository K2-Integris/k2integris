                ...
                <div className="wrapper">
                    ...
                    <div className="container">
                        <article>
                            <ul>
                                <li>
                                    <Link href="mailto:contact@k2integris.com" className="link">
                                ...
                                <li>
                                    <Link href="tel:+48 731 499 788" className="link">
                                ...
                                <li>
                                    <Link href="https://maps.google.com" target="_blank" className="link">
                            ...
                            <ul className="horizontal">
                                <li>
                                    <Link href="www.linkedin.com/company/k2integris/" target="_blank" className="social" title="Our LinkedIn">
