...
export const metadata = {
  ...
  description:
    "Learn how K2Integris collects, uses, and protects your data in full compliance with GDPR. Transparent cookie use, secure contact handling, and no personal tracking.",
};
                ...
                <article className="container">
                    ...
                    <section id="third-party-services" className="block">
                        ...
                        <ul>
                            ...
                            <li><strong>LinkedIn Lead Gen Forms:</strong> If you submit your information through a Lead Gen Form on our official LinkedIn company page, LinkedIn will collect and transmit the data you provide (such as your name, email address, job title, and company) to us. This data is used solely to respond to your inquiry, offer relevant business information, or follow up regarding our services. The data is stored securely and will not be used for unrelated marketing purposes unless explicitly stated and consented to. For more information about how LinkedIn processes your data, please refer to <a href="https://www.linkedin.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">LinkedIn’s Privacy Policy</a>.</li>
                        </ul>
